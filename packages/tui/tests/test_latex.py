...
LATEX_ASSERT_CASES = [
    ...
    ("R\\bowtie S,\\quad R\\Join S", False, "R ⋈ S, R ⋈ S"),
    ("R\\ltimes S,\\quad R\\rtimes S", False, "R ⋉ S, R ⋊ S"),
    ("R\\leftouterjoin S,\\quad R\\rightouterjoin S,\\quad R\\fullouterjoin S", False, "R ⟕ S, R ⟖ S, R ⟗ S"),
