...
def test_binds_unmodified_terminal_viewport_shortcuts_to_alternate_screen_navigation():
    ...
    assert keybindings.get_keys("tui.altScreen.lineUp") == []
    assert keybindings.get_keys("tui.altScreen.lineDown") == []
    assert keybindings.get_keys("tui.altScreen.previousPrompt") == ["ctrl+shift+up", "ctrl+up"]
    assert keybindings.get_keys("tui.altScreen.nextPrompt") == ["ctrl+shift+down", "ctrl+down"]
    assert keybindings.get_keys("tui.altScreen.search") == ["ctrl+shift+f"]
