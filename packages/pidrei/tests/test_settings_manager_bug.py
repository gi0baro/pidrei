...
@pytest.mark.tonio
async def test_preserves_file_changes_to_packages_array_when_changing_unrelated_setting(dirs):
...
@pytest.mark.tonio
async def test_preserves_file_changes_to_extensions_array_when_changing_unrelated_setting(dirs):
    agent_dir, project_dir = dirs
    settings_path = agent_dir / "settings.json"
...
@pytest.mark.tonio
async def test_preserves_external_project_settings_changes_when_updating_unrelated_project_field(dirs):
    agent_dir, project_dir = dirs
...
@pytest.mark.tonio
async def test_lets_in_memory_project_changes_override_external_changes_for_the_same_project_field(dirs):
    agent_dir, project_dir = dirs
    project_settings_path = project_dir / ".pidrei" / "settings.json"
