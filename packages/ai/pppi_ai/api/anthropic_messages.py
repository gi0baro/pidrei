...
carrier; pppi uses punkreq through the seam instead. Tests inject a fake
...
from pppi_ai.api.constrained_sampling import resolve_json_schema_strict_sampling
from pppi_ai.api.simple_options import adjust_max_tokens_for_thinking, build_base_options, clamp_max_tokens_to_context
from pppi_ai.api.transform_messages import transform_messages
from pppi_ai.registry import calculate_cost
...
from pppi_ai.utils import http
from pppi_ai.utils.cancel import CancelToken
from pppi_ai.utils.deferred_tools import split_deferred_tools
from pppi_ai.utils.event_stream import AssistantMessageEventStream
from pppi_ai.utils.json_parse import parse_json_with_repair, parse_streaming_json
from pppi_ai.utils.provider_env import get_provider_env_value
...
from pppi_ai.utils.sse import iterate_sse_messages
...
def stream(model: Model, context: Context, options: StreamOptions | None = None) -> AssistantMessageEventStream:
    ...
    async def _run() -> None:
        ...
        try:
            ...
            from pppi_ai.types import ProviderResponse
